...
class FatHourglassSeeder(csf: ControlSiteFinder) : AbstractSeeder(csf) {
    ...
    override fun seed(initialPoints: List<ControlSite>, requestedNumControls: Int, requestedCourseLength: Double): List<ControlSite> {
        ...
        val scaleFactor = requestedCourseLength * twistFactor / 4.0 //its a rectangle
        ...
        val points = listOf(first.position, third, second, fourth, last.position)
