...
object Main {
    ...
    fun main(args: Array<String>) {
        ...
        //val params = CourseParameters(distance = 6000.0, points = 8, start = GHPoint(52.988304, -1.203265))
        //val params = CourseParameters(distance = 9000.0, points = 15, start = GHPoint(53.253731, -1.469357))
        val params = CourseParameters(distance = 9000.0, points = 15, start = GHPoint(53.234060, -1.436845))
